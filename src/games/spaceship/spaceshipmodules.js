	...
	{ 	
  	...
  	'explodeSpaceship' : function() {
		...
		//var img = engine.resources.getResourceByNameAndType("spaceship", "image")
  		...
  		var x = player.vPosition.x - (resourcesInfo.find(r => r.name === 'spaceship').width / (98 * 5)) / 2;
  		var y = player.vPosition.y - (resourcesInfo.find(r => r.name === 'spaceship').height / (98 * 5)) / 2; 
